					...
					<div className="absolute w-2/3 lg:w-3/4 md:w-1/2 top-[50px] left-[150px] md:left-[250px]" key={item._id}>
						<div className="bg-white p-1 md:p-7 rounded-sm w-3/4 md:w-full flex flex-row">
							<div className="flex text-center items-center ">
								...
								<p className="font-bold text-[#063720] md:text-4xl p-4 text-2xl">
									{Math.round(item.totalRegistered * (parseFloat(item.percentageOfEnrolledParticipants)/100))}
								</p>
							</div>
						...
						<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 mt-10">
							...
							<div className="bg-white rounded-sm p-6 text-center w-3/4 md:w-full">
								...
								<p className="font-bold text-3xl">{item.percentageOfEnrolledParticipants}%</p>
							</div>
							<div className="bg-white rounded-sm p-6 text-center w-3/4 md:w-full">
								<p className="text-[14px]">
									Total registered{" "}
								...
								<p className="font-bold text-3xl">{item.femaleApplicants}</p>
							</div>
							<div className="bg-white rounded-sm p-6 text-center w-3/4 md:w-full">
								<p className="text-[14px]">
									Total registered male applicants
								</p>
								<p className="font-bold text-3xl">{item.maleApplicants}</p>
							</div>
							<div className="bg-white rounded-sm p-6 text-center w-3/4 md:w-full">
								<p className="text-[14px]">
									% of registered{" "}
								...
								<p className="font-bold text-3xl">{item.percentageOfFemaleApplicants}%</p>
							</div>
							<div className="bg-white rounded-sm p-6 text-center w-3/4 md:w-full">
								<p className="text-[14px]">
									Total disabled applicants
								</p>
								<p className="font-bold text-3xl">{item.totalDisabled}</p>
							</div>
							<div className="bg-white rounded-sm p-6 text-center w-3/4 md:w-full">
								<p className="text-[14px]">
									% of disabled applicants
								</p>
								<p className="font-bold text-3xl">{item.percentageOfDisabled}%</p>
							</div>
							<div className="bg-white rounded-sm p-6 text-center w-3/4 md:w-full">
								<p className="text-[14px]">
									Total disabled{" "}
								...
								<p className="font-bold text-3xl">{item.disabledFemale}</p>
							</div>
							<div className="bg-white rounded-sm p-6 text-center w-3/4 md:w-full">
								<p className="text-[14px]">
									Total disabled males
								</p>
								<p className="font-bold text-3xl">{item.disabledMale}</p>
							</div>
							<div className="bg-white rounded-sm p-6 text-center w-3/4 md:w-full">
								<p className="text-[14px]">
								...
								<p className="font-bold text-3xl">{item.marketingApplicants}</p>
							</div>
							<div className="bg-white rounded-sm p-6 text-center w-3/4 md:w-full">
								<p className="text-[14px]">
								...
								<p className="font-bold text-3xl">{item.tradingApplicants}</p>
							</div>
						</div>
					</div>
				))}
